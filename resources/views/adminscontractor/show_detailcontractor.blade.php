    ...
    <div class="container">
        ...
        <div class="Contractor_info">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="contractor_no" value="{{$row->contractor_no}}" disabled>
                    </div>
                ...
                <!-- Department -->
                <div class="form-group row">
                    <label for="dept_company" class="col-sm-2 col-form-label">Company</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="dept_company" value="{{$row->dept_company}}" disabled>
                    </div>
